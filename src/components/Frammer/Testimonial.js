    ...
    const testimonials = [
        {
            ...
            quote: "I've been a fan of Chikankari for years, and I must say, the quality and craftsmanship of the pieces I received from here exceeded my expectations. Truly remarkable!"
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "David Thompson",
            title: "Marketing Manager",
            quote: "I recently purchased a Chikankari outfit for my wife's birthday, and she absolutely loved it! The intricate embroidery and attention to detail make it a truly special piece."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Emily Parker",
            title: "Art Enthusiast",
            quote: "As an avid collector of traditional art forms, I was thrilled to add a Chikankari piece to my collection. The craftsmanship is exquisite, and it's a testament to the rich cultural heritage behind it."
        },
    ];
    
    return (
        <section className="relative py-14 my-48">
            <div className="relative z-10 w-full  px-32">
                <div className=" sm:text-center md:mx-auto">
                    <h3 className="text-[#FED766] text-8xl font-bold ">
                    Words of Elegance
                    </h3>
                    <p className="mt-5 text-4xl text-gray-600">
                    Discover what our customers have to say about their experiences with our exquisite Chikankari creations. 
                    </p>
                </div>
                <div className="mt-12">
                            ...
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-[#B08B59]">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 " />
                                            <div>
                                                <span className="block text-[#FFF8E7] font-semibold">{item.name}</span>
                                                <span className="block text-[#FFF8E7] text-sm mt-0.5">{item.title}</span>
                                            </div>
                                        </div>
                                    </figure>
                                </li>
