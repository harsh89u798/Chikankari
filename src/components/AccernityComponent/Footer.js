            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="justify-between items-center gap-12 md:flex">
                    <div className="flex-1 max-w-lg">
                        <h3 className="text-[#b37d53] text-2xl font-bold">
                        Stay Connected with Chikankari Delights!!
                        </h3>
                    </div>
                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-[#B08B59] shadow-sm rounded-lg"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-[#B08B59] hover:bg-[#B08B59] active:bg-[#B08B59] active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
                    {
                        footerNavs.map((item, idx) => (
                            <ul
                                className="space-y-4 text-[#b37d53]"
                                key={idx}
                            >
                                <h4 className="text-[#b37d53] font-semibold sm:pb-2">
                                    {item.label}
                                </h4>
                                {
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-[#b37d53] text-2xl font-semibold">Made with love❣️<a href='https://www.instagram.com/jadiyajii/' className=''>@Srishti
                    
                    </a></p>
                    <div className="flex items-center gap-x-6 text-[#b37d53] mt-6">
